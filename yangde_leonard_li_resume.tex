...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large Leonard Li} & Email : \href{mailto:liyangde66@gmail.com}{liyangde66@gmail.com}\\
   & Mobile : +1-206-313-5648 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Systems and Software Engineer;  GPA: 4.00}{Sept. 2018 -- Now}
    \resumeSubheading
      {Shanghai Jiao Tong University}{Shanghai, China}
      {Master of Engineering in Software Engineer;  GPA: 3.66 }{Sept. 2015 -- Mar. 2018} 
    \resumeSubheading
      {Huazhong University of Science and Technology}{Wuhan, China}
      {Bachlor of Software Engineering}{Sept. 2011 -- Jun. 2015}
